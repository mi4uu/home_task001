...
const Placeholder = () => (
  <h3 style={{ textAlign: 'center' }}>
    <img src="https://c.tenor.com/y6_NBi-9ZLQAAAAC/skyrim-margin.gif" alt="welcome" />
  </h3>
)
    ...
    <div className="App">
      <header className="App-header">
        <h1 className="logoWrap">
          {' '}
          <img src={logo} className="logo" alt="logo" /> CSV TOOL
        </h1>
        <h1 className="menuWrap">
          ...
          <Link to="/upload">
            {' '}
            <button className="button">
              <img src={uploadIcon} alt="upload new csv file" /> NEW
            </button>
          </Link>
        </h1>
      </header>
